 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="user_blogger")
 */
class Blogger extends User implements Expert {
	
	/*----- Properties -----*/
	
	/** @ORM\Column(type="date", name="blogger_since") */
	private $since;
	
	/** @ORM\Column(type="string", name="blog_name", length=100) */
	private $blogName;
	...
	/** @ORM\Column(type="string", name="postal_code", length=9) */
	private $postalCode;
